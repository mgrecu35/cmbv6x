...
CC =gcc -fPIC -g
CPP=gcc -fPIC -g
F90=ifort -shared-intel -mcmodel=medium -fPIC -fstack-security-check -g -traceback -CB  -O2  
F77=ifort -shared-intel -mcmodel=medium -fPIC -fstack-security-check -g -traceback -CB  -O2 
...
LIB =	-L$(HDF5_LIB) \
	...
	-L$(TKIO)/lib \
	-Llapack-3.4.1\
	-Lflann/lib -Lmultiscatter-1.2.10/lib -Larmadillo-9.400.3 \
        -L/PANFS/local/intel/Compiler/14.0.1/lib/intel64/ \
        -L/usr/lib/
#---List of Normal Libraires to Search for References during Linkage

LIBES = -ltkctkTSDIS -ltkcselect -ltkchdf4algs -ltkchdf4 \
        -ltkchdf5algs -ltkchdf5 -ltkc -lm -lmfhdf -ldf -lhdf5_hl -lhdf5 \
   -ljpeg -lz   -ldl -lhdf5_fortran  -lmultiscatter -llapack -lrefblas -lsvml -llapack -lrefblas 
#	-ljpeg -lz -lsvml -llapack -lrefblas -ldl -lhdf5_fortran -lflann_s 

#---Compile Stages
OBJ =	 main.o f90DataTypes.o  random.o writegif.o nbin.o \
	weightModule.o lut_routines_sjm.o \
	emissModule.o missing_flags.o read_melt_percentages.o\
	 globModule.o inputParser.o readTables_nonsph.o bisection.o cloud.o\
	absorb.o gcloud.o file_check.o writeCMBOut_TK.o writeCMBTOut_TK.o \
 	read_TRMM.o read_GPM.o read_GPM_FS.o io_subs.o getbits.o header_getter_L2.o meta_assign.o\
	geomask.o f90Types.o allocateMem.o ezlhconv.o readNh.o beamConvP.o beamConvSet.o\
	resampGMI.o interpol.o readENV.o geophysEns.o gEnv.o radarRet.Empty.o outputminmax.o radarRet.o \
        radarRet_P2.o sst.rend.o radarRet_P1.o flannModule.o\
        ...
        kgainBLAS.o interp_melt_percentages.o rteModule.o getScattProp.o armadillo_funcs.o writeCMBOut_TK_FS.o

OBJEXE	=    $(OBJ)  mainf.o  

#---Link and create Executable
combAlg.so:	$(OBJEXE) 
		icpc -openmp -shared -o \
		combAlg.so \
...
armadillo_funcs.o:
		g++ -c -fPIC -I./armadillo-9.400.3/include src_c/armadillo_funcs.cpp
