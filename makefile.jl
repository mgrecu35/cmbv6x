...
LIBES = -ltkctkTSDIS -ltkcselect -ltkchdf4algs -ltkchdf4 \
        ...
        -ljpeg -lz   -ldl -lhdf5_fortran  -lmultiscatter \
	-llapack -lrefblas 
...
OBJ =	 f90DataTypes.o  random.o writegif.o nbin.o \
	...
	radarRet_P4.o radarRet_P4_FS.o filterUp1.o \
        kgainBLAS.o interp_melt_percentages.o rteModule.o getScattProp.o armadillo_funcs.o cmbAlg.o \
						 writeCMBOut_TK_FS.o
...
combAlg.so:	$(OBJEXE) 
		icpc  -shared $(OPENMPF) -o \
		combAlg.so \
		$(OBJEXE)  $(LIB) $(LIBES) -lxml2 -lc -lflann 
